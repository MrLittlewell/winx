...
$(document).ready(function () {
    $(".scroll").on("click", function () {
      ...
      $("html, body").stop().animate({
        scrollTop: t + "px"
      }, 1100, "easeInOutExpo"), $(".main-nav ul").removeClass("active"), event.preventDefault()
    }), $(".nav-bars").on("click", function () {
      $(".main-nav ul").toggleClass("active")
    }), $(".tooltipster").tooltipster({
      theme: "tooltipster-shadow",
      maxWidth: 275
    }), $("").length && $(".promo-title-slider").slick({
      dots: !1,
      arrows: !1,
      infinite: !0,
      autoplay: !0,
      ...
      $(this).hasClass("active") || ($(".filter-links a").removeClass("active"), $(this).addClass("active"), $(".portfolio-list .row").isotope({
        filter: $(this).data("filter")
      }), $(".portfolio .actions-wrap").slideDown())
    }), $(".all-portfolio").on("click", function () {
      $(".filter-links a").removeClass("active"), $(".portfolio-list .row").isotope({
        filter: "*"
      }), $(".portfolio .actions-wrap").slideUp()
  ...
  function (e) {
    e.fn.isCorrectRequest = function () {
      ...
      var t = e(this).find('[name = "name"]'),
        o = e(this).find('[name = "phone"]'),
        i = e(this).find('[name = "email"]');
      ...
      e.ajax({
        ...
        async: !1,
        success: function (t) {
          e("input").removeClass("incorrect"), e('input[type="text"]').val(""), window.location.href = "thanks.html"
        },
        error: function (e) {
